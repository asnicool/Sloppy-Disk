  ...
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
      <div class="flex space-x-2">
        <button 
          @click="sortMode = 'name'" 
          :class="{ 'bg-blue-600': sortMode === 'name', 'bg-gray-700': sortMode !== 'name' }"
        ...
        <button 
          @click="sortMode = 'date'" 
          :class="{ 'bg-blue-600': sortMode === 'date', 'bg-gray-700': sortMode !== 'date' }"
          class="px-4 py-2 rounded-lg text-white"
        >
          Sort by Date
        </button>
        <button 
          ...
          :class="{ 'bg-blue-600': sortMode === 'random', 'bg-gray-700': sortMode !== 'random' }"
          class="px-4 py-2 rounded-lg text-white"
        >
          Random
        </button>
      ...
      <button 
        ...
        @click="loadAlbums"
        class="px-4 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-600 flex items-center gap-2"
      >
